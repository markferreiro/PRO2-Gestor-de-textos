/** @file Consultes.hh
	@brief Especificació de la classe Consultes
*/
...
public:
	...
	*/
	void procesar_consulta (string consulta);
private:
	...
	*/
	...
	/** @brief Processador consulta "tots textos ?"
		...
		/post mostra tots els textos emmagatzemats en el sistema (només el títol 
		 i l'autor de cada text) ordenats per autor i després per títol
	...
	*/
	...
	/** @brief Processador de la consulta "frases x y ?"
		@param x: Part petita (posició més petita) del rang de frases que es vol agafar del text.
		@param y: Part gran (posició més gran) del rang de frases que es vol agafar del text.
	...
	*/
	...
	/** @brief Processador de la comanda "frases <expressio> ?"
		@param expressio: String corresponent a la expressió corresponent a la consulta "frases <expresió>".
	...
	*/
	...
	/** @brief Processador de la consulta "frases "sequencia" ?"
		@param sequencia: String corresponent a la seqüencia de paraules a utilitzar en la consulta.
